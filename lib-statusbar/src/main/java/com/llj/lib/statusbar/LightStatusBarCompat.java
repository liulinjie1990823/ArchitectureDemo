...
public class LightStatusBarCompat {
  ...
  /**
   * @param window
   * @param textColorBlack true 字体为黑色 false 字体为白色
   */
  public static void setLightStatusBar(Window window, boolean textColorBlack) {
    IMPL.setLightStatusBar(window, textColorBlack);
  }
