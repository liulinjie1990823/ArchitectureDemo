...
class StatusBarCompatLollipop {
     ...
     */
    static void setStatusBarColorForCollapsingToolbar(@NonNull Window window, final AppBarLayout appBarLayout, final CollapsingToolbarLayout collapsingToolbarLayout,
