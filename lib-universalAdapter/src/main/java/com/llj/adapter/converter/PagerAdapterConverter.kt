 ...
 */
class PagerAdapterConverter<Item, Holder : XViewHolder> : PagerAdapter,
    ...
    internal constructor(universalAdapter: UniversalAdapter<Item, Holder>, viewPager: ViewPager) : super() {
        ...
        this.mSuperDataSetChangedRunnable = Runnable { superNotifyDataSetChanged() }
    ...
    private val mSuperDataSetChangedRunnable: Runnable
