...
/**
 * https://blog.csdn.net/carson_ho/article/details/52693322 ArchitectureDemo describe: author llj
 * date 2018/5/8
 */
public class CWebView extends WebView {
  ...
  //设置打开文件监听
  public void setOpenFileChooserCallBack(
  ...
  public CWebView(Context context, AttributeSet attributeSet, int i, Map<String, Object> map,
      boolean b) {
  ...
  private void initWebViewClient() {
    setWebViewClient(new WebViewClient() {
      ...
      @Override
      public void onReceivedClientCertRequest(WebView webView,
      ...
      public void onPageStarted(WebView webView, String s, Bitmap bitmap) {
        ...
        Timber.tag(TAG).i("onPageStarted -- %s", s);
      }

      //对url进行拦截
      @Override
      public boolean shouldOverrideUrlLoading(WebView webView, String s) {
        Timber.tag(TAG).i("shouldOverrideUrlLoading -- %s", s);

        if (mWebViewConfig.getIWebViewClient() != null) {
          return mWebViewConfig.getIWebViewClient().shouldOverrideUrlLoading(webView, s);
        }

        if (!TextUtils.isEmpty(mWebViewConfig.getScheme()) && s
            .startsWith(mWebViewConfig.getScheme())) {
        }
      ...
      public void onPageFinished(WebView webView, String s) {
        ...
        Timber.tag(TAG).i("onPageFinished -- %s", s);
  ...
  private void initWebChromeClient() {
    ...
    myWebChromeClient.setOpenFileChooserCallBack(new MyWebChromeClient.OpenFileChooserCallBack() {
      ...
      @Override
      public boolean showFileChooserCallBack(WebView webView, ValueCallback<Uri[]> filePathCallback,
          WebChromeClient.FileChooserParams fileChooserParams) {
        return mOpenFileChooserCallBack != null && mOpenFileChooserCallBack
            .showFileChooserCallBack(webView, filePathCallback, fileChooserParams);
      }
    });
  ...
  public static class MyWebChromeClient extends WebChromeClient {
    ...
    public interface OpenFileChooserCallBack {
      ...
      boolean showFileChooserCallBack(WebView mWebView, ValueCallback<Uri[]> filePathCallback,
          WebChromeClient.FileChooserParams fileChooserParams);
    }
    ...
    public boolean onShowFileChooser(WebView mWebView, ValueCallback<Uri[]> filePathCallback,
      ...
      return mOpenFileChooserCallBack
          .showFileChooserCallBack(mWebView, filePathCallback, fileChooserParams);
    }
    ...
    @Override
    public boolean onJsPrompt(WebView webView, String s, String s1, String s2,
