...
import com.llj.application.init.matrix.DynamicConfigImplDemo
import com.llj.application.init.matrix.TestPluginListener
 ...
 */
@AppInit(priority = 201, onlyForDebug = true, description = "MatrixInit")
