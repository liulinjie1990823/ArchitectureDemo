...
public class LoginWeChat implements ILogin {
  ...
  public void init(Context context, LoginListener listener, boolean fetchUserInfo,
    ...
    this.mIWXAPI = WXAPIFactory.createWXAPI(context.getApplicationContext(),
        SocialManager.getConfig(context.getApplicationContext()).getWxId());
    ...
    mIWXAPIEventHandler = new IWXAPIEventHandler() {
      ...
      public void onResp(BaseResp baseResp) {
        ...
        if (baseResp instanceof SendAuth.Resp
            && baseResp.getType() == ConstantsAPI.COMMAND_SENDAUTH) {
          ...
          switch (resp.errCode) {
            case BaseResp.ErrCode.ERR_OK:
              if (mFetchWxToken) {
                ...
                mLoginListener.onLoginResponse(
                    new LoginResult(LoginPlatformType.WECHAT, LoginResult.RESPONSE_LOGIN_SUCCESS,
            ...
            case BaseResp.ErrCode.ERR_USER_CANCEL:
              ...
              mLoginListener.onLoginResponse(
                  new LoginResult(LoginPlatformType.WECHAT, LoginResult.RESPONSE_LOGIN_HAS_CANCEL,
                      INFO.WX_ERR_LOGIN_CANCEL));
              break;
            case BaseResp.ErrCode.ERR_SENT_FAILED:
              Logger.e(INFO.WX_ERR_SENT_FAILED);
              mLoginListener.onLoginResponse(
                  new LoginResult(LoginPlatformType.WECHAT, LoginResult.RESPONSE_LOGIN_FAILURE,
            ...
            case BaseResp.ErrCode.ERR_AUTH_DENIED:
              ...
              mLoginListener.onLoginResponse(
                  new LoginResult(LoginPlatformType.WECHAT, LoginResult.RESPONSE_LOGIN_AUTH_DENIED,
    ...
    Task.callInBackground(new Callable<WxUser>() {
      ...
      public Void then(Task<WxUser> task) throws Exception {
        if (task.getError() != null) {
          ...
          mLoginListener.onLoginResponse(
              new LoginResult(LoginPlatformType.WECHAT, LoginResult.RESPONSE_LOGIN_SUCCESS, token,
                  task.getResult()));
        }
        return null;
      }
