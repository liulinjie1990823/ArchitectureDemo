...
public class Utils {
     ...
     * <br>The output Mat is always created of the same size as the input Bitmap and of the 'CV_8UC4'
     * type,
     ...
     * @param unPremultiplyAlpha is a flag, that determines, whether the bitmap needs to be converted
     * from alpha premultiplied format (like Android keeps 'ARGB_8888' ones) to regular one; this flag
     * is ignored for 'RGB_565' bitmaps.
     */
     ...
     * <br>The input Mat object has to be of the types 'CV_8UC1' (gray-scale), 'CV_8UC3' (RGB) or
     * 'CV_8UC4' (RGBA).
     * <br>The output Bitmap object has to be of the same size as the input Mat and of the types
     ...
     * alpha premultiplied format (like Android keeps 'ARGB_8888' bitmaps); the flag is ignored for
     * 'RGB_565' bitmaps.
     */
