            ...
            if (mCameraIndex == CAMERA_ID_ANY) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                    ...
                    if (localCameraIndex == CAMERA_ID_BACK) {
                        ...
                        Log.d(TAG, "Trying to open camera with new open(" + Integer
                            .valueOf(localCameraIndex) + ")");
                        try {
                            mCamera = Camera.open(localCameraIndex);
                        } catch (RuntimeException e) {
                            Log.e(TAG, "Camera #" + localCameraIndex + "failed to open: " + e
                                .getLocalizedMessage());
                        }
                    }
                }
                ...
                if (sizes != null) {
                    ...
                    if (Build.FINGERPRINT.startsWith("generic")
                        ...
                        params.setPreviewFormat(
                            ImageFormat.YV12);  // "generic" or "android" = android emulator
                    } else {
                    ...
                    if ((getLayoutParams().width == LayoutParams.MATCH_PARENT) && (
                        ...
                        mScale = Math
                            .min(((float) height) / mFrameHeight, ((float) width) / mFrameWidth);
                    } else {
                        mScale = 0;
                    }
    ...
    private class JavaCameraFrame implements CvCameraViewFrame {
        ...
        public Mat rgba() {
            if (mPreviewFormat == ImageFormat.NV21) {
                ...
                Imgproc.cvtColor(mYuvFrameData, mRgba, Imgproc.COLOR_YUV2RGB_I420,
