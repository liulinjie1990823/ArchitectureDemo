 ...
 * date 2018/8/16
 */
@Route(path = CRouter.APP_COORDINATOR_LAYOUT_ACTIVITY)
class CoordinatorLayoutActivity : MainMvcBaseActivity<ViewBinding>() {
  @BindView(R2.id.vp_container) lateinit var mVpContent: ViewPager
