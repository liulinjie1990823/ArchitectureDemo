...
public class MemoryLeakActivity extends MainMvcBaseActivity<ActivityMemoryLeakBinding> {
  ...
  public static class DynamicProxyHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      LogUtil.i("DynamicProxyHandler",
          "我正在动态代理[" + proxy.getClass().getSimpleName() + "]的[" + method.getName() + "]方法");
