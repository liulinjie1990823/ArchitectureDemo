...
/**
 * ArchitectureDemo. describe: author llj date 2019/4/16
 */
@Route(path = CRouter.APP_KODO_ACTIVITY)
public class KodoActivity extends MainMvcBaseActivity {

  public static final        String           RECORDER_PATH = FilePathHelper.CACHE_PATH + "recoder";
  @BindView(R2.id.sdv_show)   SimpleDraweeView mSdvShow;
  @BindView(R2.id.btn_upload) Button           mBtnUpload;
  @BindView(R2.id.btn_show)   Button           mBtnShow;
    ...
    mBtnUpload.setOnClickListener(new DebouncingOnClickListener() {
      ...
      public void doClick(View v) {
        ...
        File file = new File(Environment.getExternalStorageDirectory() + "/" + ".mv/"
            + "73F09569AFDF7A7328AD427144F348DD.mp4");
