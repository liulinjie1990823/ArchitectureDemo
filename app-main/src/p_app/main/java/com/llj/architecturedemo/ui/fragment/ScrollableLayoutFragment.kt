 ...
 * date 2018/10/30
 */
class ScrollableLayoutFragment : MainMvpBaseFragment<ViewBinding, ScrollableLayoutPresenter>(), IScrollableLayoutView {
    @BindView(R2.id.cv_toolbar) lateinit var mCvToolbar: ConstraintLayout
    @BindView(R2.id.refreshLayout) lateinit var mRefreshLayout: JHSmartRefreshLayout
    @BindView(R2.id.scrollableLayout) lateinit var mScrollableLayout: ScrollableLayout
    @BindView(R2.id.ll_header) lateinit var mLiHeader: LinearLayout
    @BindView(R2.id.tab) lateinit var mTab: MagicIndicator
    @BindView(R2.id.viewpager) lateinit var mViewpager: androidx.viewpager.widget.ViewPager
