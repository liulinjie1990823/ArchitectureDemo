...
public class AEncryptUtils {
     ...
     * @return the bytes of MD2 encryption
     */
    public static byte[] digestMD2(final byte[] data) {
    ...
    public static String md5(final String data, final String salt) {
        ...
        if (salt == null) return hex(digestMD5(data.getBytes()));
        if (data == null) return hex(digestMD5(salt.getBytes()));
        return hex(digestMD5((data + salt).getBytes()));
    }
    ...
    public static String md5(final byte[] data, final byte[] salt) {
        if (data == null && salt == null) return "";
        if (salt == null) return hex(digestMD5(data));
        if (data == null) return hex(digestMD5(salt));
        byte[] dataSalt = new byte[data.length + salt.length];
        System.arraycopy(data, 0, dataSalt, 0, data.length);
        System.arraycopy(salt, 0, dataSalt, data.length, salt.length);
        return hex(digestMD5(dataSalt));
    }
     ...
     * @return the hex string of file's MD5 encryption
     */
    public static String md5FileToString(final String filePath) {
        File file = isSpace(filePath) ? null : new File(filePath);
        return md5FileToString(file);
    }
     ...
     * @return the bytes of file's MD5 encryption
     */
    public static byte[] digestMd5File(final String filePath) {
        File file = isSpace(filePath) ? null : new File(filePath);
        return digestMd5File(file);
    }
     ...
     * @return the hex string of file's MD5 encryption
     */
    public static String md5FileToString(final File file) {
        return hex(digestMd5File(file));
    }
     ...
     * @return the bytes of file's MD5 encryption
     */
    public static byte[] digestMd5File(final File file) {
     ...
     * @return the bytes of SHA1 encryption
     */
    public static byte[] digestSHA1(final byte[] data) {
     ...
     * @return the bytes of SHA224 encryption
     */
    public static byte[] digestSHA224(final byte[] data) {
        return digest(data, "SHA224");
    }
     ...
     * @return the bytes of SHA256 encryption
     */
    public static byte[] digestSHA256(final byte[] data) {
     ...
     * @return the bytes of SHA384 encryption
     */
    public static byte[] digestSHA384(final byte[] data) {
        return digest(data, "SHA384");
    }
     ...
     * @return the bytes of SHA512 encryption
     */
    public static byte[] digestSHA512(final byte[] data) {
    ...
    public static String encryptHmacSHA224ToString(final byte[] data, final byte[] key) {
        return hex(hmacSHA224(data, key));
    }
    ...
    public static String encryptHmacSHA256ToString(final byte[] data, final byte[] key) {
        return hex(hmacSHA256(data, key));
    }
    ...
    public static String encryptHmacSHA384ToString(final byte[] data, final byte[] key) {
        return hex(hmacSHA384(data, key));
    }
    ...
    public static String encryptHmacSHA512ToString(final byte[] data, final byte[] key) {
        return hex(hmacSHA512(data, key));
    }
     ...
     * @return the bytes of hmac encryption
     */
    private static byte[] hmac(final byte[] data,
                                       final byte[] key,
     ...
     * @return the Base64-encode bytes of DES encryption
     */
    public static byte[] encryptDESToBase64(final byte[] data,
                                           final byte[] key,
     ...
     * @return the hex string of DES encryption
     */
    public static String encryptDESToHexString(final byte[] data,
                                              final byte[] key,
                                              final String transformation,
                                              final byte[] iv) {
        return hex(encryptDES(data, key, transformation, iv));
    }
     ...
     * @return the Base64-encode bytes of 3DES encryption
     */
    public static byte[] encrypt3DESToBase64(final byte[] data,
                                            final byte[] key,
                                            final String transformation,
                                            final byte[] iv) {
     ...
     * @return the hex string of 3DES encryption
     */
    public static String encrypt3DESToHexString(final byte[] data,
                                               final byte[] key,
                                               final String transformation,
                                               final byte[] iv) {
        return hex(encrypt3DES(data, key, transformation, iv));
    }
     ...
     * @return the Base64-encode bytes of AES encryption
     */
    public static byte[] encryptAESToBase64(final byte[] data,
                                           final byte[] key,
                                           final String transformation,
                                           final byte[] iv) {
     ...
     * @return the hex string of AES encryption
     */
    public static String encryptAESToHexString(final byte[] data,
                                              final byte[] key,
                                              final String transformation,
                                              final byte[] iv) {
        return hex(encryptAES(data, key, transformation, iv));
    }
     ...
     * @return the Base64-encode bytes of RSA encryption
     */
    public static byte[] encryptRSAToBase64(final byte[] data,
                                           final byte[] key,
     ...
     * @return the hex string of RSA encryption
     */
    public static String encryptRSAToHexString(final byte[] data,
                                              final byte[] key,
                                              final boolean isPublicKey,
                                              final String transformation) {
        return hex(encryptRSA(data, key, isPublicKey, transformation));
    }
