...
public class ATimeUtils {
  ...
  public static SimpleCalendar getSimpleCalendar(Calendar calendar, long millis) {
    ...
    return new SimpleCalendar(millis, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1,
   ...
   *
   * @param format 1："yyyy年MM月dd日 HH时mm分ss秒" 2:"yyyy-MM-dd HH:mm:ss" 3:"yyyy/MM/dd HH:mm:ss"
   * 4:"yyyy年MM月dd日 HH时mm分ss秒 E " 5:"yyyy/MM/dd E" 6."yyyy/MM/dd"
   ...
   */
  public static ArrayMap<String, List<String>> getMonthBetween(long minDate, long maxDate)
      throws ParseException {
  ...
  public static String getNewTimeString(Context context, Long milliseconds) {
    ...
    if (beforeDate.getYear() == afterDate.getYear()) {
      if (beforeDate.getDate() == afterDate.getDate() && beforeDate.getMonth() == afterDate
          .getMonth()) {
   ...
   *
   * @param format 1："yyyy年MM月dd日 HH时mm分ss秒" 2:"yyyy-MM-dd HH:mm:ss" 3:"yyyy/MM/dd HH:mm:ss"
   * 4:"yyyy年MM月dd日 HH时mm分ss秒 E " 5:"yyyy/MM/dd E" 6."yyyy/MM/dd"7.yyyy-MM-dd HH:mm
   * @return dateStr 指定格式字符串
   */
   ...
   *
   * @param format 格式 <li>1."yyyy年MM月dd日 HH时mm分ss秒"</li> <li> 2."yyyy-MM-dd HH:mm:ss"</li>
   * <li>3."yyyy/MM/dd HH:mm:ss"</li>
   * <li>4."yyyy年MM月dd日 HH时mm分ss秒 E "</li> <li>5."yyyy/MM/dd E"</li>
   * <li>
   * 6."yyyy/MM/dd"</li> <li>7."yyyy-MM-dd HH:mm"</li> <li> 8."yyyy年MM月dd日"</li>
   * <li>9."yyyy-MM-dd"</li>
   * @param dateStr 时间字符串
   * @return date格式
   */
   ...
   *
   * @param format 格式 1："yyyy年MM月dd日 HH时mm分ss秒" 2:"yyyy-MM-dd HH:mm:ss" 3:"yyyy/MM/dd HH:mm:ss"
   * 4:"yyyy年MM月dd日 HH时mm分ss秒 E " 5:"yyyy/MM/dd E" 6."yyyy/MM/dd"
   * @param dateStr 时间字符串
   * @return Milliseconds
   */
  ...
  public static List<String> countDownString(long milliseconds) {
    ...
    long second =
        milliseconds % MILLIS_PER_DAY % MILLIS_PER_HOUR % MILLIS_PER_MINUTE / MILLIS_PER_SECOND;
  ...
  public static List<Long> countDownLong(long milliseconds) {
