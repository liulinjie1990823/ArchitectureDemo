...
class Login extends StatelessWidget implements IGetTaskView {
  ...
  _accountValue(CounterModel model) {
  ...
  _codeValue(CounterModel model) {}

  _pwdValue(CounterModel model) {}
  ...
  Widget build(BuildContext context) {
    print("Login build");
    var counterModel = CounterModel.of(context);

//    _accountController.addListener(_accountValue(counterModel));
//    _pwdController.addListener(_pwdValue(counterModel));
//    _codeController.addListener(_codeValue(counterModel));
