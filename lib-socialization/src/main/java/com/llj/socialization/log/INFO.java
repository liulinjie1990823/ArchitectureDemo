...
public class INFO {
    ...
    // for shareActivity
    public static final String ACTIVITY_CREATE     = "ResponseActivity onCreate";
    public static final String ACTIVITY_RESUME     = "ResponseActivity onResume";
    public static final String ACTIVITY_RESULT     = "ResponseActivity onActivityResult";
    public static final String ACTIVITY_NEW_INTENT = "ResponseActivity onNewIntent";
