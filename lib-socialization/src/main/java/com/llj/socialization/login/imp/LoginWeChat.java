...
public class LoginWeChat implements LoginInterface {
    ...
    public LoginWeChat(final Activity activity, final LoginListener listener, final boolean fetchUserInfo) {
        mLoginListener = listener;
        mIWXAPI = WXAPIFactory.createWXAPI(activity, SocialManager.CONFIG.getWxId());
