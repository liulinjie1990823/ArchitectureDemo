...
package com.llj.socialization.login.wbapi;
...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int WRITE_API_SHARE           = 6;
    ...
    static {
        ...
        sAPIList.put(WRITE_API_UPDATE, API_BASE_URL + "/updateUI.json");
    ...
    public void upload(String content, Bitmap bitmap, String lat, String lon, RequestListener listener) {
        ...
        requestAsync(sAPIList.get(WRITE_API_SHARE), params, HTTPMETHOD_POST, listener);
    }

    public void upload(String status, String imageUrl, String pic_id, String lat, String lon, RequestListener listener) {
     ...
     * @param listener
     */
    public void upload(String status, ByteArrayOutputStream byteArrayOutputStream, String pic_id, String lat, String lon, RequestListener listener) {
        WeiboParameters params = new WeiboParameters(mAppKey);
        //为了解决分享gif的bug
        LinkedHashMap<String, Object> mParams = new LinkedHashMap();
        mParams.put("status", status);
        mParams.put("pic", byteArrayOutputStream);
     ...
     * @param listener 异步请求回调接口
     */
    public void uploadUrlText(String status, String contentType, String imageUrl, String pic_id, String lat, String lon,
