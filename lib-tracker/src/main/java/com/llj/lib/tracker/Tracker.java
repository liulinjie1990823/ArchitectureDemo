...
public class Tracker {
  ...
  public static void trackApp(Object object, @TrackerEvent.PageType String eventName) {
    ...
    TrackerEvent trackerEvent = new TrackerEvent(TrackerEvent.TYPE_PAGE, eventName, pageName,
  ...
  public static void trackPage(Object object, @TrackerEvent.PageType String eventName) {
    ...
    TrackerEvent trackerEvent = new TrackerEvent(TrackerEvent.TYPE_PAGE, eventName, iTracker,
        System.currentTimeMillis());
  ...
  public static void trackEvent(View view, @TrackerEvent.ActionType String eventName) {
    ...
    TrackerEvent trackerEvent = new TrackerEvent(TrackerEvent.TYPE_ACTION, eventName, iTracker,
        System.currentTimeMillis());
  ...
  private static ITracker getTracker(View view) {
    ...
    if (context instanceof FragmentActivity) {
      ...
      if (parentFragment != null) {
        ...
        if (rectParent.contains(rectView) && (parentFragment instanceof ITracker)
            && (!((ITracker) parentFragment).ignoreAction())) {
        ...
        if (childFragment != null) {
          ...
          if (rectChild.contains(rectView) && (childFragment instanceof ITracker)
              && (!((ITracker) childFragment).ignoreAction())) {
