...
public class CustomBoostFlutterActivity extends Activity
    implements FlutterActivityAndFragmentDelegate.Host,
    LifecycleOwner {

  private static final String TAG = "NewCustomBoostFlutterActivity";
  ...
  public static NewEngineIntentBuilder withNewEngine() {
    return new NewEngineIntentBuilder(CustomBoostFlutterActivity.class);
  }


  public static class NewEngineIntentBuilder {
    private final Class<? extends CustomBoostFlutterActivity> activityClass;
    private String                                            backgroundMode = DEFAULT_BACKGROUND_MODE;
    private String url = "";
    private Map params = new HashMap();


    public NewEngineIntentBuilder(@NonNull Class<? extends CustomBoostFlutterActivity> activityClass) {
  ...
  public CustomBoostFlutterActivity() {
