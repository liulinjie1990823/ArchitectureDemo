...
class NativePageActivity : AppCompatActivity(), View.OnClickListener {
  ...
  private lateinit var mOpenFlutterLgoin: TextView
  private lateinit var mOpenFlutterMain: TextView
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    mOpenFlutterLgoin = findViewById(R.id.open_flutter_login)
    mOpenFlutterMain = findViewById(R.id.open_flutter_main)
    mOpenFlutterFragment = findViewById(R.id.open_flutter_fragment)
    mOpenNative.setOnClickListener(this)
    mOpenFlutter.setOnClickListener(this)
    mOpenFlutterLgoin.setOnClickListener(this)
    mOpenFlutterMain.setOnClickListener(this)
  ...
  override fun onClick(v: View) {
    ...
    } else if (v === mOpenFlutterLgoin) {
      PageRouter.openPageByUrl(this, PageRouter.FLUTTER_MY_LOGIN_PAGE_URL, params)
    } else if (v === mOpenFlutterMain) {
      PageRouter.openPageByUrl(this, PageRouter.FLUTTER_MY_MAIN_PAGE_URL, params)
