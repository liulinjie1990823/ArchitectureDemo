...
public class ViewPager2Activity extends AppMvcBaseActivity<ActivityViewpager2Binding> {
  ...
  @Nullable
  @Override
  public ActivityViewpager2Binding layoutViewBinding() {
    return ActivityViewpager2Binding.inflate(getLayoutInflater());
  }
  ...
  public void initViews(@Nullable Bundle savedInstanceState) {
    ...
    ((ViewGroup) mViewBinder.vpPicture.getChildAt(0)).setClipToPadding(false);
    //画面的宽度，按比例计算
    ...
    ConstraintLayout.LayoutParams layoutParams = (ConstraintLayout.LayoutParams) mViewBinder.vpPicture
        .getLayoutParams();
    layoutParams.width = -1;
    layoutParams.height =
        mPicHeight + mViewBinder.vpPicture.getPaddingTop() + mViewBinder.vpPicture
            .getPaddingBottom();

    mViewBinder.vpPicture.setOffscreenPageLimit(3);
    ViewPager2.PageTransformer pageTransformer = new ViewPager2.PageTransformer() {
      ...
      private float mCenterPosition = mViewBinder.vpPicture.getPaddingLeft() / (mPicWidth * 1f);
    ...
    //  }
    //});
    mViewBinder.vpPicture.setAdapter(new RecyclerView.Adapter<ViewHolderHelper>() {
  ...
  public void initData() {
    mViewBinder.vpPicture.getChildAt(0);
  }
