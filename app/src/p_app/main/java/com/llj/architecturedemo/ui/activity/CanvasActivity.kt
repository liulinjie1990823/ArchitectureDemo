...
class CanvasActivity : DataListActivity() {
  ...
  companion object {
    ...
    val drawRoundRect = 1
    @JvmField val drawCircle = 2
    @JvmStatic val drawOval = 3

    var drawArc = 4
    @JvmField var drawLine = 5
    @JvmStatic var drawLines = 6

    @JvmStatic val drawPath = 7
    @JvmStatic val drawBitmap1 = 8
    @JvmStatic val drawBitmap2 = 9
    @JvmStatic val drawBitmap3 = 10
    @JvmStatic val translate = 11
    @JvmStatic val scale = 12
    @JvmStatic val rotate = 13
  }
}