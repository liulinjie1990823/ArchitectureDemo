package com.llj.architecturedemo.matrix;
...
public class DynamicConfigImplDemo implements IDynamicConfig {
  ...
  public int get(String key, int defInt) {
    ...
    if(IDynamicConfig.ExptEnum.clicfg_matrix_trace_app_start_up_threshold.name().equals(key)){
      return 1;
    }
    if(IDynamicConfig.ExptEnum.clicfg_matrix_trace_warm_app_start_up_threshold.name().equals(key)){
      return 1;
    }
