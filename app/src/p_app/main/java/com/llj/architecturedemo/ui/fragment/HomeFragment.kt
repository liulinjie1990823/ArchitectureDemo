 ...
 * date 2018/8/15
 */
class HomeFragment : MainMvcBaseFragment<ViewBinding>(), ScrollableHelper.ScrollableContainer {
  ...
  override fun initViews(savedInstanceState: Bundle?) {
    ...
    val cRouterClassName = Class.forName(CRouterClassName::class.java.name)
