...
/**
 * ArchitectureDemo. describe: author llj date 2019/1/7
 */
@Route(path = CRouter.APP_REWARD_LAYOUT_ACTIVITY)
public class RewardLayoutActivity extends MainMvcBaseActivity {

  @BindView(R2.id.rewardLayout) RewardLayout mRewardLayout;
  @BindView(R2.id.tv_click)     TextView     mClick;
  ...
  public class Gift implements GiftIdentify, Cloneable {
    ...
    public Gift(int userId, int giftId, String userName, String giftName, int giftImg,
        long giftStayTime) {
      this.userId = userId;
      this.giftId = giftId;
