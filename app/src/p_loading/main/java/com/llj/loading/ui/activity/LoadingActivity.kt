...
import com.llj.architecturedemo.databinding.ActivityLoadingBinding
...
@LayoutId(id = R.layout.activity_loading)
class LoadingActivity : AppMvcBaseActivity<ActivityLoadingBinding>() {
